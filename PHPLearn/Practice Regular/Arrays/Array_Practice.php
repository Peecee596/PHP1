...
--replace function directly replaces with the index/ key wherever matches but array_splice replaces with the index and length
...
$a76=["kjh","hjhj","hujk"];
$b93=["Orange","Apple"];
array_splice($a76,2,-3,$b93);//negative length doesnt replaces whaeas its just insert the data from the index no and shift the other elements if available in the 1st array
echo"<pre>";
print_r($a76);
echo"</pre>";
...
echo"<pre>";
print_r($a63);//-if given length is negative then, it calculates backwards and deletes the index no element and consider for the o/p till the length given backwards
echo"</pre>";
