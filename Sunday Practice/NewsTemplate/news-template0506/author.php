            ...
            <div class="col-md-8">
                ...
                <div class="post-container">
                    ...
                    <?php
                     ...
                     $sql3="SELECT * from user where user_id='{$autid}'";
                  ...
                  $catid=$_GET['id'];
                   ...
                   <?php
                    ...
                    <ul class='pagination'>
                        <?php
                            $sql1="SELECT * from post where author='{$autid}'";
                                ...
                                
                            {
                                ...
                                echo '<li class="'.$active.'"><a href="author.php?id='.$autid.'&page='.$i.'">'.$i.'</a></li>';
                            }
