...
<html>
   <head>
        ...
        <meta http-ehttp://localhost/practice-sunday-1/news-template0506/admin/post.phpquiv="X-UA-Compatible" content="ie=edge">
    ...
    if(isset($_POST['login']))
    {
        ...
        {
            echo"<div class='alert alert-danger'>ID password doesnt match</div>";
        }
    }
